...
/***/ function(module, exports, __webpack_require__) {
	...
	var _gameStore = __webpack_require__(155);

	var _gameStore2 = _interopRequireDefault(_gameStore);

	var _gameActions = __webpack_require__(170);

	var _gameActions2 = _interopRequireDefault(_gameActions);

	var _GameTutorial = __webpack_require__(171);

	var _GameTutorial2 = _interopRequireDefault(_GameTutorial);

	var _GameLoading = __webpack_require__(223);

	var _GameLoading2 = _interopRequireDefault(_GameLoading);

	var _GamePlay = __webpack_require__(224);

	var _GamePlay2 = _interopRequireDefault(_GamePlay);

	var _GameEnd = __webpack_require__(230);

	var _GameEnd2 = _interopRequireDefault(_GameEnd);

	var _sockets = __webpack_require__(172);
	...
	var SheepGame = function (_React$Component) {
	  ...
	  _createClass(SheepGame, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      _sockets2.default.on('verify', function (id) {
	        //sets the dog information
	        _gameActions2.default.setId(id);
	      });

	      _sockets2.default.on('gameLoading', function (gameState) {
	        _gameActions2.default.updateGameState(gameState);
	      });

	      _sockets2.default.on('updateGame', function (newGameObj) {
	        _gameActions2.default.updateGame(newGameObj);
	      });

	      _sockets2.default.on('gameStart', function (newGameObj, gameState) {
	        this.emitKeyInfo();
	        _gameActions2.default.updateGame(newGameObj);
	        _gameActions2.default.updateGameState(gameState);
	      }.bind(this));

	      _sockets2.default.on('gameEnd', function (gameState, gameInfo) {
	        _gameActions2.default.updateGameState(gameState);
	    ...
	    value: function emitKeyInfo() {
	      ...
	      _sockets2.default.emit('keyInfo', keyInfo);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GameDispatcher = __webpack_require__(164);

	var _GameDispatcher2 = _interopRequireDefault(_GameDispatcher);

	var _gameConstants = __webpack_require__(168);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Sheep = __webpack_require__(157);
	...
	var _Dogs = __webpack_require__(161);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Dogs = function Dogs() {
	  ...
	  this.myDog.image.src = __webpack_require__(162);
	  this.theirDog = {};
	  this.theirDog.image = new Image();
	  this.theirDog.image.src = __webpack_require__(163);
	};
	...
	var GameTutorial = function () {
	  ...
	  _createClass(GameTutorial, [{
	    ...
	    value: function handleClick() {
	      ...
	      _sockets2.default.emit('joinGame', id);
	    }
	  }, {
	    key: 'render',
	    value: function render() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var currDomain = 'localhost';
	var port = '3000';
	module.exports = _socket2.default.connect('http://' + currDomain + ':' + port);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SheepActive = __webpack_require__(227);

	var _SheepActive2 = _interopRequireDefault(_SheepActive);

	var _SheepLost = __webpack_require__(228);

	var _SheepLost2 = _interopRequireDefault(_SheepLost);

	var _SheepPenned = __webpack_require__(229);
